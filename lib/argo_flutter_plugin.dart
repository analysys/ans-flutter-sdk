...
class ArgoFlutterPlugin {
  static const MethodChannel _channel = const MethodChannel('argo_flutter_plugin');
  ...
  static void registerSuperProperty( String superPropertyName,
